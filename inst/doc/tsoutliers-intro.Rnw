...
%\VignetteKeyword{outliers, R, time series}
...
given in \href{http://www.jalobe.com:8080/doc/tsoutliers.pdf}{this document}.
%
...
\href{http://www.jalobe.com:8080/blog/tsoutliers/}{%
http://www.jalobe.com:8080/blog/tsoutliers/} and \\
